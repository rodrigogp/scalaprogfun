...
class ListsSuite extends FunSuite {
  ...
  test("sum of a few numbers: list with repeated numbers") {
    assert(sum(List(1, 2, 3, 3, 5, 5, 0)) === 19)
  }

  test("sum of a few numbers: list with a negative number") {
    assert(sum(List(-1, 2, 0)) === 1)
  }

  test("sum of a few numbers: list with only zero values") {
    assert(sum(List(0, 0)) === 0)
  }

  test("sum of a few numbers: empty list") {
    assert(sum(List()) === 0)
  }
  ...
  test("max of a few numbers: list with repeated numbers") {
    assert(max(List(3, 7, 5, 7, 5, 2)) === 7)
  }

  test("max of a few numbers: list with a negative number") {
    assert(max(List(3, 7, 2, -8)) === 7)
  }

  test("max of a few numbers: list with a zero value") {
    assert(max(List(3, 7, 2, 0)) === 7)
  }

  test("max of a few numbers: list with only 1 value") {
    assert(max(List(3)) === 3)
  }

  test("max of a few numbers: empty list") {
